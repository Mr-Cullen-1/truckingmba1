...
class ExamSession(models.Model):
    ...
    phone = models.CharField(max_length=30, blank=True, null=True) # Mock uchun ixtiyoriy
    exam_date = models.DateField()
    group = models.CharField(max_length=100)
    teacher = models.CharField(max_length=200, blank=True, null=True) # Mock uchun ixtiyoriy
